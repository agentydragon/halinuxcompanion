...
class NotificationHints(BaseModel):
    ...
    urgency: Optional[UrgencyLevel] = Field(
        default=None,
        description="Urgency level (0=low, 1=normal, 2=critical)"
    )
    
    # Not yet implemented but defined in spec
    action_icons: Optional[bool] = Field(
        default=None,
        description="Use icon names in actions instead of text"
    )
    ...
    desktop_entry: Optional[str] = Field(
        default=None,
        description="Desktop filename without .desktop suffix"
    )
    image_path: Optional[str] = Field(
        default=None,
        description="Alternative image location"
    )
    ...
    resident: Optional[bool] = Field(
        default=None,
        description="Keep notification after action invoked"
    )
    ...
    suppress_sound: Optional[bool] = Field(
        default=None,
        description="Suppress sound playback"
    )
    transient: Optional[bool] = Field(
        default=None,
        description="Hint for transient notifications"
    )
    x: Optional[int] = Field(
        default=None,
        description="X position hint"
    )
    y: Optional[int] = Field(
        default=None,
        description="Y position hint"
    )
...
class DBusNotification(BaseModel):
    ...
    body: str = Field(
        default="",
        description="The optional detailed body text. Can be empty."
    )
    ...
    hints: NotificationHints = Field(
        default_factory=NotificationHints,
        description="Structured notification hints"
    )
